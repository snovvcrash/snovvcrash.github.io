...
Меня зовут `snovvcrash`, я увлечен областью <strike>похека</strike> анализа защищенности, и это мой блог. Здесь можно найти: мои прохождения уязвимых виртуальных машин; периодически обновляемую шпаргалку по пентесту, разработке и администрированию; мои контакты и список других ресурсов, где со мной можно связаться при необходимости.
