...
>
> Автор блога не несет отвественности за деструктивные последствия, вызванные неправомерным использование информации, размещенной на страницах данного блога.
