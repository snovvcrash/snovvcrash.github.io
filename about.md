...
Меня зовут `snovvcrash`, я увлечен областью компьютерной безопасности, и это мой блог. Здесь можно найти: прохождения уязвимых виртуальных машин; шпаргалки по пентесту, разработке, администрированию; заметки с CTF-мероприятий<strike>; шоколадку</strike>.

Добавляй в закладки, у нас весело!
...
Если я случайно сделал что-то, за что хотелось бы сказать спасибо, можно угостить меня кофе по ссылке ниже :coffee:
