...
Version ([красивый отчет](/assets/reports/nmap/htb/mischief/version.html)):
```text
...
Version ([красивый отчет](/assets/reports/nmap/htb/mischief/udp-version.html)):
```text
...
Подвержена той же уязвимости, что и docker-контейнеры, о чем мы уже говорили в [прохождении Olympus](https://snovvcrash.github.io/2018/10/03/htb-olympus.html#privesc-prometheus--root-способ-1).
...
Для этого нам нужно находиться на одном канальном уровне (aka *OSI layer 2*) с тем хостом, адрес которого мы хотим узнать. Пусть [Hawk](https://snovvcrash.github.io/2018/12/09/htb-hawk.html) станет нашим связующим звеном (aka *Pivot Point*).
...
[![icmp-shell.gif](/assets/images/htb/machines/mischief/icmp-shell.gif)](/assets/images/htb/machines/mischief/icmp-shell.gif)
