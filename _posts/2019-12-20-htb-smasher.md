...
> 4. **➤**{:.green} [Return-to-bss, криптооракулы и реверс-инжиниринг против Великого Сокрушителя](/2019/12/20/htb-smasher.html)
...
Классический GDB без обвесов по умолчанию следит за выполнением **родительского** процесса, однако [установленный](/2019/11/23/bitterman.html#вооружение-gdb) ассистент PEDA будет мониторить **дочерний** процесс, если в ходе выполнения был форк. Это эквивалентно настройке `set follow-fork-mode child` в оригинальном GDB.
...
Необходимые звенья ROP-цепочки можно найти вручную (как мы [делали](/2019/11/23/bitterman.html#rop-цепочки) это в прошлой части), а можно возложить все заботы на плечи pwntools — тогда конечный сплоит получится весьма миниатюрным.
