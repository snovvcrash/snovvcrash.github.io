...
author: snovvcrash
categories: /pentest
tags: [write-up, hackthebox, windows, apache, apache-tomcat, default-password, war, java, reverse-shell]
comments: true
published: true
---
...
[![banner.png]({{ "/assets/images/htb/jerry/banner.png" | relative_url }})](https://www.hackthebox.eu/home/machines/profile/144 "Hack The Box :: Jerry")
{: .center-image}

![info.png]({{ "/assets/images/htb/jerry/info.png" | relative_url }})
{: .center-image}
...
Version ([красивый отчет]({{ "/assets/reports/nmap/htb/jerry/version.html" | relative_url }})):
```text
...
[![port80-browser-1.png]({{ "/assets/images/htb/jerry/port80-browser-1.png" | relative_url }})]({{ "/assets/images/htb/jerry/port80-browser-1.png" | relative_url }})
{: .center-image}
...
[![port80-browser-2.png]({{ "/assets/images/htb/jerry/port80-browser-2.png" | relative_url }})]({{ "/assets/images/htb/jerry/port80-browser-2.png" | relative_url }})
{: .center-image}
...
[![port80-browser-3.png]({{ "/assets/images/htb/jerry/port80-browser-3.png" | relative_url }})]({{ "/assets/images/htb/jerry/port80-browser-3.png" | relative_url }})
{: .center-image}
...
![owned-user.png]({{ "/assets/images/htb/jerry/owned-user.png" | relative_url }})
{: .center-image}

![owned-root.png]({{ "/assets/images/htb/jerry/owned-root.png" | relative_url }})
{: .center-image}

![trophy.png]({{ "/assets/images/htb/jerry/trophy.png" | relative_url }})
{: .center-image}
