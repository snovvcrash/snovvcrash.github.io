...
author: snovvcrash
tags: [write-up, hackthebox, machine, linux, path-traversal, lfi, jq, docker, restricted-shell, rbash, capabilities, bashrc]
---
...
<p align="right">
  <a href="https://www.hackthebox.eu/home/machines/profile/149"><img src="https://img.shields.io/badge/%e2%98%90-Hack%20The%20Box-8ac53e?style=flat-square" alt="htb-badge.svg" /></a>
  <span class="score-medium">5/10</span>
</p>

![banner.png](/assets/images/htb/machines/waldo/banner.png)
{:.center-image}

![info.png](/assets/images/htb/machines/waldo/info.png)
{:.center-image}
...
Version ([красивый отчет](/assets/reports/nmap/htb/waldo/version.html)):
```text
...
[![port80-browser-1.png](/assets/images/htb/machines/waldo/port80-browser-1.png)](/assets/images/htb/machines/waldo/port80-browser-1.png)
{:.center-image}
...
[![port80-burp.png](/assets/images/htb/machines/waldo/port80-burp.png)](/assets/images/htb/machines/waldo/port80-burp.png)
{:.center-image}
...
[![port80-browser-2.png](/assets/images/htb/machines/waldo/port80-browser-2.png)](/assets/images/htb/machines/waldo/port80-browser-2.png)
{:.center-image}
...
![owned-user.png](/assets/images/htb/machines/waldo/owned-user.png)
{:.center-image}

![owned-root.png](/assets/images/htb/machines/waldo/owned-root.png)
{:.center-image}

![trophy.png](/assets/images/htb/machines/waldo/trophy.png)
{:.center-image}
