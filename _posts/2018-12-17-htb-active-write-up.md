...
[![xakep.png]({{ "/img/xakep.png" | relative_url }})](https://xakep.ru/2019/06/27/htb-kerberos/ "Укрощение Kerberos. Захватываем Active Directory на виртуальной машине с HackTheBox - «Хакер»")
{: style="float: right; margin-left: 10px; width: 100px; height: 100px;"}
