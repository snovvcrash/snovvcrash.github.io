...
author: snovvcrash
categories: /pentest
tags: [write-up, hackthebox, linux, path-traversal, lfi, jq, docker, restricted-shell, rbash, capabilities, bashrc]
comments: true
published: true
---
...
[![banner.png]({{ "/assets/images/htb/waldo/banner.png" | relative_url }})](https://www.hackthebox.eu/home/machines/profile/149 "Hack The Box :: Waldo")
{: .center-image}

![info.png]({{ "/assets/images/htb/waldo/info.png" | relative_url }})
{: .center-image}
...
Version ([красивый отчет]({{ "/assets/reports/nmap/htb/waldo/version.html" | relative_url }})):
```text
...
[![port80-browser-1.png]({{ "/assets/images/htb/waldo/port80-browser-1.png" | relative_url }})]({{ "/assets/images/htb/waldo/port80-browser-1.png" | relative_url }})
{: .center-image}
...
[![port80-burp.png]({{ "/assets/images/htb/waldo/port80-burp.png" | relative_url }})]({{ "/assets/images/htb/waldo/port80-burp.png" | relative_url }})
{: .center-image}
...
[![port80-browser-2.png]({{ "/assets/images/htb/waldo/port80-browser-2.png" | relative_url }})]({{ "/assets/images/htb/waldo/port80-browser-2.png" | relative_url }})
{: .center-image}
...
![owned-user.png]({{ "/assets/images/htb/waldo/owned-user.png" | relative_url }})
{: .center-image}

![owned-root.png]({{ "/assets/images/htb/waldo/owned-root.png" | relative_url }})
{: .center-image}

![trophy.png]({{ "/assets/images/htb/waldo/trophy.png" | relative_url }})
{: .center-image}
