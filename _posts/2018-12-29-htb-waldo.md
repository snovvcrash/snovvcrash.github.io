...
author: snovvcrash
tags: [hackthebox, ctf, write-up, box, Waldo, linux, path-traversal, lfi, jq, docker, restricted-shell, rbash, capabilities, bashrc]
comments: true
published: true
---

[![htb-badge.svg](https://img.shields.io/badge/%e2%98%90-hackthebox.eu-8ac53e?style=flat-square)](https://www.hackthebox.eu/home/machines/profile/149 "Hack The Box :: Waldo")
...
Version ([красивый отчет]({{ "/reports/nmap/htb/waldo/version.html" | relative_url }})):
```text
